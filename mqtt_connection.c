...
#define SEC_TAG 42 // Un numéro arbitraire, doit correspondre au provisioning
#define TLS_CERTIFICATE_FILE "crt_card_Thingy91_1.crt"
#define TLS_PRIVATE_KEY_FILE "crt_card_Thingy91_1.key"
#define TLS_CA_CERTIFICATE_FILE "NemeusProject-CA.crt"
#endif
...
int client_init(struct mqtt_client *client)
{
    ...
    // --- Ajoutez cette section pour activer TLS ---
    static sec_tag_t sec_tag_list[] = { SEC_TAG };

    static struct mqtt_sec_config tls_config = {
        .peer_verify = 2, // 2 = vérifier le serveur
        .cipher_count = 0,
        .cipher_list = NULL,
        .sec_tag_list = sec_tag_list,
        .sec_tag_count = 1,
        .hostname = CONFIG_MQTT_BROKER_HOSTNAME, // Pour SNI, si supporté
    };
